...
// Changes:
// - Added MKV file extension mapping.
//
...
namespace Kyse.AspNetCore.StaticLibrary
{
    ...
    /// </summary>
    public class LibraryContentTypeProvider : IContentTypeProvider
    {
        #region Extension mapping table
        /// <summary>
        /// Creates a new provider with a set of default mappings.
        /// </summary>
        public LibraryContentTypeProvider()
        ...
        public LibraryContentTypeProvider(IDictionary<string, string> mapping)
        {
            if (mapping == null)
            {
